...
\begin{frame}{Определение деревьев решений}
\begin{figure}
    \begin{tikzpicture}
      ...
      \path [connector] (t1) -- (t2);
      \path [connector] (t1) -- (t8);
      \path [connector] (t1) -- (t5);
      \path [connector] (t2) -- (t3);
      \path [connector] (t2) -- (t4);
      \path [connector] (t8) -- (t6);
      \path [connector] (t8) -- (t7);
      \node[draw=none] at (-2, 3) (action) {Молодой};
      \node[draw=none] at (0, 3) (action) {Средний};
      \node[draw=none] at (2, 3) (action) {Пожилой};
      \node[draw=none] at (-4, 1) (action) {Нет};
      \node[draw=none] at (-2, 1) (action) {Да};
      \node[draw=none] at (1, 1) (action) {Посредственная};
      \node[draw=none] at (4, 1) (action) {Безупречная};
    \end{tikzpicture}
